...
SELECT = option_menu(
    ...
    styles={"container": {"padding": "0!important", "background-color": "white", "size": "cover", "width": "100"},
            ...
            "nav-link": {"font-size": "30px", "text-align": "center", "margin": "-2px", "--hover-color": "#ADD8E6"},
            "nav-link-selected": {"background-color": "##E6E6FA"}})

# connection with MongoDB
client = pymongo.MongoClient("localhost:27017")
db = client.Youtube_Data_Saranya  # Database
...
api_key = "AIzaSyCsbEXq4SgJ4DVIBIM8MliriRS-hxgM7EQ"
...
if SELECT == "Home":
    st.write(
        "## :green[**About :[Technologies used] : Youtube Data API,MongoDB,MySql,Streamlit,Python**] .")
    st.write(
...
# EXTRACT DATA AND TRANSFORM PAGE:
if SELECT == "EXTRACT & TRANSFORM":
    tab1, tab2 = st.tabs(["$EXTRACT DATA$", "$TRANSFORM $"])
    ...
    with tab1:
        ...
        if ch_id and st.button("Extract Data", key="extract_button"):
            st.markdown("<span style='font-family: Arial; font-size: 30px;'>Extract Data</span>",
                        unsafe_allow_html=True)
        ...
        if st.button("Upload to MongoDB"):
            with st.spinner('Please Wait for it...'):
                ...
                st.success("Successfully Upload to MongoDB!!")
    ...
    if st.button("Submit"):
        try:
            ...
            st.success("Successfully Transformed to MySQL!!")
        except:
...
if SELECT == "View":
    ...
    if questions == '1. What are the names of all the videos and their corresponding channels?':
        ...
        mycursor.execute("""SELECT channel_name AS Channel_Name,Video_name AstreamlitstreamS Title,Like_count AS Like_Count 
                            FROM videos
